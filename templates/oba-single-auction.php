			...
			<div class="oba-card oba-phase-card" data-step="registration">
				...
				<div class="oba-phase-body">
					...
					<div class="oba-autobid-setup" style="display:none;margin-top:12px;">
						<div class="oba-card" style="padding:12px;display:flex;gap:12px;align-items:center;justify-content:space-between;flex-wrap:wrap;">
							...
							<div style="display:flex;flex-direction:column;align-items:flex-end;gap:4px;min-width:160px;">
								...
								<span class="oba-autobid-state" style="font-size:14px;font-weight:700;color:#0f172a;">—</span>
							</div>
						</div>
					</div>
				</div>
